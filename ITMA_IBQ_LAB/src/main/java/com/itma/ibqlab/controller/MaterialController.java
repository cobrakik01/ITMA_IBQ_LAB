...
public class MaterialController implements Serializable {
    ...
    @EJB
    private com.itma.ibqlab.controller.MaterialFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("MaterialCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("MaterialUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("MaterialDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<Material> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<Material> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class MaterialControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Material) {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Material.class.getName()});
                return null;
            }
        }
