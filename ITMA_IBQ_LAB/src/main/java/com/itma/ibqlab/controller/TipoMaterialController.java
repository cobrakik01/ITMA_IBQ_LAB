...
public class TipoMaterialController implements Serializable {
    ...
    @EJB
    private com.itma.ibqlab.controller.TipoMaterialFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("TipoMaterialCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("TipoMaterialUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("TipoMaterialDeleted"));
        if (!JsfUtil.isValidationFailed()) {
